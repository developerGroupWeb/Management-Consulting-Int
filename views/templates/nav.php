<div class='' style=''>
    <nav class="navbar navbar-expand-md w-100 py-sm-2" id="sidebar" style="z-index: 10000; background-color: rgba(0,0,0,0.7); position: fixed; top: 0;">
        <a class="navbar-brand font-weight-bold" href="/"><img src="/public/images/My-logo.png" alt="" class='img-fluid d-none d-sm-block'> <img src="/public/images/logo-mobile.png" alt="" class='img-fluid d-sm-none'></a>
