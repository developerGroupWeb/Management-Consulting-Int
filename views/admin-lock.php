<div class='container-fluid'>
    <div class='row'>
        <div class='col-md-3'>
            <div class='row'>
                <button class="btn btn-light card-header w-100 border font-weight-bold" type="button">
                    Creer une annonce
                </button>
            </div>
                ...
                <div class="accordion col-12" id="accordionExample">
                    <div class="card row">
                        <div class="card-header" id="headingThree">
                            <button class="btn w-100 border collapsed font-weight-bold" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            Categories
                            </button>
            ...
            <div class='row'>
                <button class="btn btn-light card-header w-100 border font-weight-bold" type="button">
                    Messages <span class="badge badge-success">N</span>
                </button>
            </div>

            <div class='row'>
                <button class="btn btn-light card-header w-100 border font-weight-bold" type="button">
                    Liste des annonces <span class="badge badge-success">N</span>
                </button>
            </div>
        </div>
